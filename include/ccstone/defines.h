...
#ifndef DEBUG
#define DEBUG(fmt, ...) ALOGV("%s[L%d]%s: " fmt "\n",basename(__FILE__),__LINE__,__FUNCTION__,## __VA_ARGS__)
#endif
...
#define FILE_ID 0
#endif
#define ERRNUMSTR(fmt, ...) (status)(ALOG(LOG_VERBOSE, LOG_TAG, fmt, ##__VA_ARGS__) & 0 ) | CSM_CUSTOM( FILE_ID )
#define ERRNUM(ERR)  (status)(CSM_STATUS((ERR)))
#endif
